...
- **Divine Intuition**: Once per long rest, you can reroll any d20 and take either result
...
- **Empowered Healing**: All healing you perform or receive is increased by 3x (replacing previous multiplier). This includes:
  - Healing spells (cure wounds, healing word, etc.)
  - Healing potions (a standard healing potion now heals 3d4+3 × 3)
  - Class healing abilities (lay on hands, second wind, etc.)
  - Hit dice recovery during rests
...
- **Divine Aura**: Enemies within 30 feet must make a Wisdom save (DC 17) or be frightened of you; allies gain advantage on saving throws 3x per day
- **Divine Intuition**: Increase to 3x and now includes ability to give an ally advantage on any roll once per short rest (counts as 1 use)
- **Divine Teleportation**: As a bonus action, teleport up to 60 feet to a space you can see

- **Divine Speed**: Your movement speed increases by 20ft, and you gain an additional action 1/day
- **Divine Decree**: Once per long rest, issue one divine command that cannot be resisted:
  - "**I forbid your magic**": Target creature can't cast spells for the next 2 rounds (no save)
  - "**I command your obedience**": Target must follow one simple command (no save)
  - "**I deny your power**": You can determine a target's special abilities and choose one that they will lose until the end of their next turn (no save)
  - "**I grant you my blessing**": Cast Bless on the target as a bonus action
- **Divine Form** improves with the following enhancements:
  - +4 to AC (stacks with Divine Armor)
  - +50 temporary hit points
  - Your weapons and spells deal an additional 3d8 radiant damage
- **Reality Alteration**: Once per long rest, you can change one aspect of reality within 100 feet for 1 minute (similar to the Wish spell but more limited in scope)
- **Divine Regeneration**: At the start of each of your turns, regain 15 hit points

## Class-Specific Divine Abilities (Gained at Level 2)
...
- **Level 2**: 
  - Your Sneak Attack deals additional radiant damage equal to your proficiency bonus
  - You can hide as a bonus action even when observed, vanishing into divine shadow
- **Level 3**: 
  - When you use Cunning Action, you can briefly step into the celestial plane, becoming incorporeal until your next turn
  - Your critical hits with ranged weapons create a burst of divine light, dealing 4d8 radiant damage to all enemies within 10 feet of the target
  - **Divine Domain**: Create a 60-foot area of shadows where allies can hide even in plain sight and gain +10 to Stealth
  - **Divine Theft**: Once per long rest, you can "steal" one magical effect, spell, or ability you can see and use it yourself within 1 minute

### Cleric/Paladin/Sorcerer: Avatar of Divine Justice
- **Level 2**: 
  - Your divine spells ignore resistance to their damage type and treat immunity as resistance
  - Your Channel Divinity and Divine Smite deal maximum damage and affect all enemies in a 15-foot cone
- **Level 3**: 
  - When you cast a healing spell, add your Charisma modifier to the total and the target gains temporary hit points equal to your level
  - Your weapon attacks count as +3 magical weapons and deal an additional 2d8 radiant damage
  - **Divine Domain**: Create a 60-foot zone of sanctity where undead and fiends take 4d10 radiant damage when entering
  - **Divine Avatar**: For 1 minute (1/long rest), your spells cost no spell slots, your Divine Smites deal maximum damage, and you emanate an aura of healing (10 HP to all allies within 30 feet at the start of your turn)

### Bard/Warlock: Voice of Celestial Harmony
- **Level 2**: 
  - Your bardic inspiration dice are doubled when rolled and can be used for saving throws against celestial or fiendish beings
  - Your songs can be heard across planes of existence, and you can cast Message or Sending without components to any creature you've met
- **Level 3**: 
  - When you cast a spell that charms or controls, celestial and fiendish creatures have disadvantage on their saving throws
  - Your performance can now heal (3d8 + your Charisma modifier) all allies who can hear you once per short rest
...
- **Level 3**: 
  ...
  - Your critical hits with weapons heal you for half the damage dealt and grant you advantage on all attacks until the end of your next turn
